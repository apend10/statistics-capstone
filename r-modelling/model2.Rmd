...
This is a first version of the fixed effects model which ONLY financial and demographic data. We are using transfermarkt_financial_final.csv here. The data is from 2004/05 to 2024/25. This is 21 years of data.
...
This is a second version of the mixed effects model with only **performance based data.** The data comes from final_combined_squad_stats.csv. All the data is from the 2017-18 to 2024-25 season which is a lot less than model 2.1!

First, we will do a quick data set exploration to understand what all these columns are.
